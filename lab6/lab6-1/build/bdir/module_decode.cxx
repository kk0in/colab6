...
MOD_module_decode::MOD_module_decode(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190(100u),
    DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189(91u),
    DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188(79u)
{
...
{
  tUInt32 DEF_x__h1794;
  tUInt32 DEF_x__h1707;
  tUInt32 DEF_x__h1619;
  ...
  tUInt32 DEF_x__h1542;
  tUInt32 DEF_immI__h24;
  DEF_x__h1542 = (tUInt32)(ARG_decode_inst >> 20u);
  DEF_immI__h24 = primSignExt32(32u, 12u, (tUInt32)(DEF_x__h1542));
  ...
  DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d3 = DEF_opcode__h18 == (tUInt8)19u;
  ...
  case (tUInt8)55u:
    ...
    break;
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d135 = DEF_rs1__h21;
  }
  DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d26 = DEF_opcode__h18 == (tUInt8)55u;
  switch (DEF_opcode__h18) {
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_de_ETC___d148 = DEF_rs2__h22;
  }
  DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d2 = DEF_opcode__h18 == (tUInt8)51u;
  ...
  case (tUInt8)0u:
  case (tUInt8)1u:
    DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b0_OR_decode__ETC___d90 = DEF_funct3__h20;
    break;
  case (tUInt8)4u:
  ...
  DEF_x__h1619 = 2097151u & (((((((tUInt32)(DEF_decode_inst_BIT_31___d162)) << 20u) | (((tUInt32)((tUInt8)((tUInt8)255u & (ARG_decode_inst >> 12u)))) << 12u)) | (((tUInt32)((tUInt8)((tUInt8)1u & (ARG_decode_inst >> 20u)))) << 11u)) | (((tUInt32)(1023u & (ARG_decode_inst >> 21u))) << 1u)) | (tUInt32)((tUInt8)0u));
  DEF_immJ__h28 = primSignExt32(32u, 21u, (tUInt32)(DEF_x__h1619));
  DEF_x__h1707 = 8191u & (((((((tUInt32)(DEF_decode_inst_BIT_31___d162)) << 12u) | (((tUInt32)((tUInt8)((tUInt8)1u & (ARG_decode_inst >> 7u)))) << 11u)) | (((tUInt32)((tUInt8)((tUInt8)63u & (ARG_decode_inst >> 25u)))) << 5u)) | (((tUInt32)((tUInt8)((tUInt8)15u & (ARG_decode_inst >> 8u)))) << 1u)) | (tUInt32)((tUInt8)0u));
  DEF_immB__h26 = primSignExt32(32u, 13u, (tUInt32)(DEF_x__h1707));
  DEF_x__h1794 = 4095u & ((((tUInt32)((tUInt8)(ARG_decode_inst >> 25u))) << 5u) | (tUInt32)(DEF_decode_inst_BITS_11_TO_7___d29));
  DEF_immS__h25 = primSignExt32(32u, 12u, (tUInt32)(DEF_x__h1794));
  switch (DEF_opcode__h18) {
  case (tUInt8)3u:
  case (tUInt8)19u:
  case (tUInt8)103u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 = DEF_immI__h24;
    break;
  case (tUInt8)111u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 = DEF_immJ__h28;
    break;
  case (tUInt8)99u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 = DEF_immB__h26;
    break;
  case (tUInt8)35u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 = DEF_immS__h25;
    break;
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 = DEF_immU__h27;
  }
  DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188.set_bits_in_word(32767u & ((((((tUInt32)(DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011___d28)) << 14u) | (((tUInt32)(4095u & DEF_immI__h24)) << 2u)) | (((tUInt32)(!DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d2 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d3 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1101111___d5 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d6 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d7 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d21 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d24 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d26 || DEF_decode_inst_BITS_6_TO_0_EQ_0b10111___d27))))))))) << 1u)) | (tUInt32)((tUInt8)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186 >> 31u))),
										 2u,
										 0u,
										 15u).set_whole_word((((tUInt32)(2147483647u & DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d186)) << 1u) | (tUInt32)((tUInt8)(2863311530llu >> 32u)),
												     1u).set_whole_word((tUInt32)(2863311530llu),
															0u);
  DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189.set_bits_in_word(134217727u & (((((((tUInt32)(DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d2 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d3 || (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111___d118 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d6 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d7 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d21 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d24 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d26 || DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011___d28))))))))) << 26u) | (((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d135)) << 21u)) | (((tUInt32)(DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d2 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d3 && (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111___d118 && (!DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d6 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d7 || DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d24)))))) << 20u)) | (((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_de_ETC___d148)) << 15u)) | DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188.get_bits_in_word32(2u,
																																																																																																																																																      0u,
																																																																																																																																																      15u)),
										 2u,
										 0u,
										 27u).set_whole_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188.get_whole_word(1u),
												     1u).set_whole_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188.get_whole_word(0u),
															0u);
  DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190.build_concat(68719476735llu & ((((((tUInt64)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d94)) << 33u) | (((tUInt64)(!(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d103 == (tUInt8)0u) && (DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d2 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d3 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1101111___d5 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d6 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d7 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d21 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d24 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d26 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b10111___d27 || DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011___d28))))))))))) << 32u)) | (((tUInt64)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d103)) << 27u)) | (tUInt64)(DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189.get_bits_in_word32(2u,
																																																																																																																								       0u,
																																																																																																																								       27u))),
									     64u,
									     36u).set_whole_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189.get_whole_word(1u),
												 1u).set_whole_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189.get_whole_word(0u),
														    0u);
  PORT_decode.set_bits_in_word(4095u & (((((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d45)) << 8u) | (((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_IF_ETC___d72)) << 4u)) | (tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190.get_bits_in_word8(3u,
																																					    0u,
																																					    4u))),
			       3u,
			       0u,
			       12u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190.get_whole_word(2u),
						   2u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190.get_whole_word(1u),
								      1u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190.get_whole_word(0u),
											 0u);
  return PORT_decode;
}
...
unsigned int MOD_module_decode::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190", 100u);
  vcd_write_def(sim_hdl, num++, "decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189", 91u);
  vcd_write_def(sim_hdl, num++, "decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188", 79u);
...
void MOD_module_decode::vcd_defs(tVCDDumpType dt, MOD_module_decode &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
    ...
    {
      if ((backing.DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190) != DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190)
      {
	vcd_write_val(sim_hdl, num, DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190, 100u);
	backing.DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190 = DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_deco_ETC___d190;
      }
      ++num;
      if ((backing.DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189) != DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189)
      {
	vcd_write_val(sim_hdl, num, DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189, 91u);
	backing.DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189 = DEF_decode_inst_BITS_6_TO_0_EQ_0b110011_OR_decode__ETC___d189;
      }
      ++num;
      if ((backing.DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188) != DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188)
      {
	vcd_write_val(sim_hdl, num, DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188, 79u);
	backing.DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188 = DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011_8_CONCAT__ETC___d188;
      }
      ++num;
